...
window.addEventListener('load', function () {
	var RopExcludePosts = new _vue2.default({
		...
		components: {
			ExcludePostsPage: _excludePostsPage2.default
		},
		created: function created() {}
	});
}); // jshint ignore: start
...
if (false) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/uvdev/Local Sites/rop/app/public/wp-content/plugins/tweet-old-post/vue/src/vue-elements/exclude-posts-page.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, __vue_template__)
...
// module
exports.push([module.i, "\n    #rop-sidebar-selector[_v-2401e5d8] {\n        border: 1px solid #e5e5e5;\n        background: #fff;\n    }\n\n    #rop-posts-listing .rop-post-item td[_v-2401e5d8] {\n        position: relative;\n    }\n\n    #rop-posts-table[_v-2401e5d8] {\n        margin-top: 20px;\n    }\n\n    #rop-posts-listing .rop-post-item:hover button.rop-exclude-post[_v-2401e5d8] {\n        display: block;\n    }\n\n    #rop-posts-listing .rop-post-item td button.rop-exclude-post[_v-2401e5d8] {\n        position: absolute;\n        top: 5px;\n        right: 10px;\n        display: none;\n        padding: 0px 20px;\n    }\n\n    .rop-post-true[_v-2401e5d8] {\n        opacity: 0.8;\n        background-color: #F6DBDA;\n\n    }\n\n    .rop-load-more-posts[_v-2401e5d8] {\n        text-align: center;\n    }\n", ""]);
	...
	methods: {
		...
		excludeSinglePost: function excludeSinglePost(post_id, state) {
			...
			this.$store.dispatch('fetchAJAXPromise', {
				...
				var findex = false;
				var fdata = {};
				var exists = _this.postsAvailable.some(function (post, index) {
				...
				if (findex !== false) {
					if (state) {
						_vue2.default.delete(_this.postsAvailable, findex);
					} else {
						_vue2.default.set(_this.postsAvailable, findex, fdata);
					}
				}
				_this.$log.info('Excluding post ', findex);
				_this.$log.debug('Succesfully fetched.');
			}, function (error) {
				_this.is_loading_single = false;
				_this.$log.error('Can not exclude post settings.');
			});
		},
		excludePostsBatch: function excludePostsBatch() {
			var _this2 = this;
			...
			this.$store.dispatch('fetchAJAXPromise', {
				...
				_this2.postsAvailable.map(function (post, index) {
					post.selected = true;
				});
				_this2.$log.debug('Succesfully excluded based on key.', _this2.searchQuery);
			}, function (error) {
				_this2.is_loading = false;
				_this2.$log.error('Can not exclude in batch.');
			});
		},
		...
		excludeTaxonomiesChange: function excludeTaxonomiesChange() {
			this.requestPostUpdate();
		},
		excludePostsChange: function excludePostsChange() {
			this.requestPostUpdate();
		},
		doPostUpdate: function doPostUpdate() {
			var _this4 = this;

			var new_page = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : true;
			...
			this.$store.dispatch('fetchAJAXPromise', {
				...
				_this4.is_loading_single = false;
				_this4.$log.info('Successfully loaded psots.');
			}, function (error) {
				_this4.is_loading = false;
				_this4.is_loading_single = false;
		...
		saveGeneralSettings: function saveGeneralSettings() {
			...
			this.$store.dispatch('fetchAJAXPromise', {
				...
				_this5.$log.info('Successfully saved general settings.');
			}, function (error) {

				_this5.$log.error('Successfully saved general settings.');
				_this5.is_loading = false;
				_vue2.default.$log.error('Got nothing from server. Prompt user to check internet connection and try again', error);
			});
		}
...
if (false) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/uvdev/Local Sites/rop/app/public/wp-content/plugins/tweet-old-post/vue/src/vue-elements/reusables/popover.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, __vue_template__)
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-b10f9494&file=popover.vue!../../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!../../../../node_modules/eslint-loader/index.js!../../../../node_modules/eslint-loader/index.js!./popover.vue", function() {
			var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-b10f9494&file=popover.vue!../../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!../../../../node_modules/eslint-loader/index.js!../../../../node_modules/eslint-loader/index.js!./popover.vue");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
